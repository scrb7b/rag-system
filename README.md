...
|---|---|---|
| `faithfulness` | **0.83** | Відповідь спирається на контекст (без галюцинацій) |
| `answer_relevancy` | **0.46** | Відповідь відповідає запитанню |
| `context_precision` | n/a | Вимагає reference-відповідей у тестовому наборі |
| `context_recall` | **0.89** | Контекст покриває необхідну інформацію |
